/* LAB-03 - Faixas em threads, e a primeira race.   preparatório, sem nota
 *
 ...
 *
 * ENTREGA - o que se pontua aqui é o DIAGNÓSTICO, não a correção:
 *   1. o portão falhando de forma reproduzível, com o número da execução;
 *   2. uma frase dizendo quais duas linhas deste arquivo correm juntas e qual
 *      leitura se perde;
 *   3. por que o arquivo de imagem continua correto e só o hist= muda.
 *
 * Não conserte. O conserto é o LAB-05.
 */
#include "crono.h"
#include "filtro.h"
#include "janela.h"
