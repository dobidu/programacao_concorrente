/* LAB-02 - SOLUÇÃO de referência: o mesmo filtro em dois processos, por pipe.
 *
...
int main(int argc, char **argv) {
    ...
    if (filho == 0) {
        ...
        close(tubo[1]);                     /* não escreve: fecha a ponta de escrita */
    ...
    close(tubo[0]);                         /* não lê: fecha a ponta de leitura */
    double t0 = agora_ms();
    ...
    close(tubo[1]);                         /* o fecho é o fim de arquivo do filho */
