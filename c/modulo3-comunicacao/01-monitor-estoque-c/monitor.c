...
/* 15 por consumidor: 2x15 = 30 = o que os 3 produtores produzem. Com 10, os
   produtores travavam de vez em nao_cheio depois que os consumidores saíam. */
void* cons(void* a) { int id=*((int*)a); for(int i=0;i<15;i++){consumir(&mon,id);usleep(rand()%300000);} return NULL; }
